...
class Grafico:
    ...
    def main_productivity_graph(self):
        ...
        self.axs[0, 1].plot(df["Semana"], df["Projetos"], label="Projetos", color="r", marker="o")
        self.axs[0, 1].plot(df["Semana"], df["Cursos"], label="Cursos", color="b", marker="o")
        self.axs[0, 1].set_title("FMC e Cálculo")
        self.axs[0, 1].legend(fontsize="small", loc="lower left")
        self.axs[1, 0].plot(df["Semana"], df["AWS"], label="AWS", color="c", marker="o")
        self.axs[1, 0].plot(df["Semana"], df["Leituras"], label="Leituras", color="m", marker="o")
        self.axs[1, 0].set_title("ITP e Leetcode")
        self.axs[1, 0].legend(fontsize="small", loc="lower left")
        self.axs[1, 1].plot(df["Semana"], df["FMC2"], label="FMC2", color="g", marker="o")
        self.axs[1, 1].plot(df["Semana"], df["ARQ"], label="ARQ", color="y", marker="o")
        self.axs[1, 1].set_title("Currículo, Cursos e Leituras")
        self.axs[1, 1].legend(fontsize="small", loc="lower left")
        self.axs[0, 2].plot(df["Semana"], df["EDB1"], label="EDB1", color="black", marker="o")
        self.axs[0, 2].plot(df["Semana"], df["LP1"], label="LP1", color="black", marker="o")
        self.axs[1, 1].legend(fontsize="small", loc="lower left")
        self.axs[0, 2].set_title("EDB1 e LP1")
